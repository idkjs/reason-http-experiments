...
module ReadableStream = {
  [@bs.send] external isPaused: Js.t(#readableStream) => bool = "isPaused";
  [@bs.send.pipe: Js.t(#readableStream)]
  external pause: unit => Js.t(#readableStream) = "pause";
  [@bs.send]
  external pipe:
  ...
  external setReadableHighWaterMark: (Js.t(#readableStream), int) => int =
    "readableHighWaterMark";
  [@bs.send] external read: (Js.t(#readableStream), int) => dataOut = "read";
  [@bs.get]
  external getReadableLength: Js.t(#readableStream) => int = "readableLength";
  [@bs.send.pipe: Js.t(#readableStream)]
  external resume: unit => Js.t(#readableStream) = "resume";
  [@bs.send]
  external setEncoding: string => Js.t(#readableStream) = "setEncoding";
...
module WritableStream = {
  [@bs.send] external cork: Js.t(#writableStream) => unit = "cork";
  [@bs.send] external endStream: Js.t(#writableStream) => unit = "end";
  [@bs.send] external uncork: Js.t(#writableStream) => unit = "uncork";
  [@bs.get]
  external getWritableHighWaterMark: Js.t(#writableStream) => int =
    "writableHighWaterMark";
  [@bs.get]
  external getWritableLength: Js.t(#writableStream) => int = "writableLength";
  [@bs.send]
  ...
  external writeBuffer:
    ...
    bool =
    "write";
  external destroy: (Js.t(#writableStream), Js.Exn.t) => unit = "destroy";
